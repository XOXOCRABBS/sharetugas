                          ...
                          child: Slidable(
                                  ...
                                  onPressed: (context) {
                                    ...
                                    Navigator.push(
                                      context, MaterialPageRoute(
                                        builder: ((context) => Managepgw(mpegawai: pgw, index: index,))
                                      )
                                    );
                                  },
                            ...
                            endActionPane: ActionPane(
                              ...
                              children: [
                                SlidableAction(
                                  onPressed: (context) {
                                    Pegawai().hapus_pegawai(
                                      UserModel(id: records.id, nama: null, posisi: null, gajipokok: null, uangmakan: null, izin: null, rool: null)
                                    );
                                  },
