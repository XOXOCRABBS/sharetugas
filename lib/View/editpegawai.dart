...
class Managepgw extends StatefulWidget {
  ...
  final index;
  const Managepgw({this.mpegawai, this.index});
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Center(
                child: iseditingmode == true ? const Text("Edit Pegawai", style: TextStyle(fontSize: 28),) : const Text("Tambah Mahasiswa", style: TextStyle(fontSize: 28),),
              ),
                ...
                Padding(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        Mytextfield(labeltext: "NAMA", hintedtext: "Isi Nama Pegawai", mycontroller: nama), const SizedBox(height: 10),
                        Mytextfield(labeltext: "POSISI", hintedtext: "Isi Posisi Pegawai", mycontroller: posisi), const SizedBox(height: 10),
                        Mytextfield(labeltext: "GAJI POKOK", hintedtext: "Isi Gaji Pokok Pegawai", mycontroller: gajipokok), const SizedBox(height: 10),
                        Mytextfield(labeltext: "UANG MAKAN", hintedtext: "Isi Uang Makan Pegawai", mycontroller: uangmakan), const SizedBox(height: 10),
                        Mytextfield(labeltext: "EMAIL", hintedtext: "Isi Email Pegawai", mycontroller: email), const SizedBox(height: 10),
                        Mytextfield(labeltext: "PASSWORD", hintedtext: "Isi Password Pegawai", mycontroller: password), const SizedBox(height: 10),
                      ],
                    )
                  ),
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_form_key.currentContext! != null){
                  ...
                  child: iseditingmode == true ? Text("Update") : Text("Save"),
                )
            ],
          ),
        ),
